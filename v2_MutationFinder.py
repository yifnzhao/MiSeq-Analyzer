...
#    sys.stdout=stdoutOrigin
    ...
    stdoutOrigin=sys.stdout 
    sys.stdout = open("PTEN3_log20190301.txt", "w")
    ...
    piechart('PTEN3-1.csv','PTEN2-1.png');
    piechart('PTEN3-2.csv','PTEN2-2.png');
    piechart('PTEN3-3.csv','PTEN2-3.png');
    piechart('PTEN3-4.csv','PTEN2-4.png');
    piechart('PTEN3-5.csv','PTEN2-5.png');
    piechart('PTEN3-6.csv','PTEN2-6.png');
    piechart('PTEN2-7.csv','PTEN2-7.png');
    piechart('PTEN2-8.csv','PTEN2-8.png');
    piechart('PTEN2-9.csv','PTEN2-9.png');
    piechart('PTEN2-10.csv','PTEN2-10.png');
